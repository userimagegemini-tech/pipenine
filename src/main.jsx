...
function FullAdmin() {
  ...
  {tab==='site'&&singleton('Site identity and agency details','site','/api/admin/site',[
    ['brandName','Brand name','text',true],['brandSuffix','Brand suffix','text',true],['logoUrl','Logo image','text',true],['tagline','Tagline'],['phone','Phone','tel',true],['email','Public email','email',true],['address','Address','text',true],['notificationEmails','Contact notification emails','textarea']
  ])}
